...
tape('dDatabase Core Tests: hash copy', function (t) {
  var a = create()
...
tape('dDatabase Core Tests: chaos monkey generated #1', function (t) {
  var ops = []
  ops.push({type: 'append', value: '998'})
  ops.push({type: 'copy', block: 0, from: 'ddb', to: 'fork1'})
  runOps(t, ops)
})

tape('dDatabase Core Tests: chaos monkey generated #2', function (t) {
  var ops = []
  ...
  ops.push({type: 'copy', block: 1, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '982'})
  ops.push({type: 'copy', block: 0, from: 'fork1', to: 'fork2'})
  ops.push({type: 'copy', block: 3, from: 'ddb', to: 'fork1'})
  runOps(t, ops)
})

tape('dDatabase Core Tests: chaos monkey generated #3', function (t) {
  var ops = []
  ops.push({type: 'append', value: '996'})
  ops.push({type: 'append', value: '994'})
  ops.push({type: 'copy', block: 1, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 1, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '991'})
  ops.push({type: 'append', value: '990'})
  ops.push({type: 'append', value: '988'})
  ops.push({type: 'append', value: '985'})
  ops.push({type: 'copy', block: 5, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 5, from: 'fork1', to: 'fork2'})
  ...
  ops.push({type: 'copy', block: 8, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 8, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '965'})
  ops.push({type: 'copy', block: 6, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 3, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '961'})
  ops.push({type: 'copy', block: 6, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '957'})
  ops.push({type: 'append', value: '956'})
  ops.push({type: 'copy', block: 3, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '953'})
  ops.push({type: 'append', value: '952'})
  ops.push({type: 'append', value: '951'})
  ops.push({type: 'append', value: '950'})
  ops.push({type: 'copy', block: 17, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '947'})
  ops.push({type: 'append', value: '946'})
  ops.push({type: 'copy', block: 18, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '944'})
  ops.push({type: 'copy', block: 22, from: 'ddb', to: 'fork1'})
  runOps(t, ops)
})

tape('dDatabase Core Tests: chaos monkey randomized #4', function (t) {
  var ops = []
  ...
  ops.push({type: 'copy', block: 2, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '459'})
  ops.push({type: 'copy', block: 1, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '455'})
  ops.push({type: 'append', value: '450'})
  ops.push({type: 'copy', block: 2, from: 'fork1', to: 'fork2'})
  ...
  ops.push({type: 'copy', block: 16, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '427'})
  ops.push({type: 'append', value: '426'})
  ops.push({type: 'copy', block: 16, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '421'})
  ops.push({type: 'append', value: '420'})
  ops.push({type: 'copy', block: 4, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '415'})
  ops.push({type: 'append', value: '411'})
  ops.push({type: 'copy', block: 4, from: 'fork1', to: 'fork2'})
  ...
  ops.push({type: 'copy', block: 24, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 9, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 24, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '390'})
  ops.push({type: 'append', value: '389'})
  ops.push({type: 'copy', block: 9, from: 'fork1', to: 'fork2'})
  ops.push({type: 'copy', block: 11, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 23, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '384'})
  ops.push({type: 'copy', block: 0, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '380'})
  ops.push({type: 'copy', block: 26, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 29, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '371'})
  ops.push({type: 'copy', block: 15, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 27, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '366'})
  ops.push({type: 'copy', block: 11, from: 'fork1', to: 'fork2'})
  ops.push({type: 'copy', block: 29, from: 'fork1', to: 'fork2'})
  ops.push({type: 'copy', block: 15, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '357'})
  ops.push({type: 'copy', block: 0, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '351'})
  ops.push({type: 'append', value: '349'})
  ops.push({type: 'copy', block: 23, from: 'fork1', to: 'fork2'})
  ops.push({type: 'copy', block: 8, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 27, from: 'fork1', to: 'fork2'})
  ops.push({type: 'copy', block: 14, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 14, from: 'fork1', to: 'fork2'})
  ...
  ops.push({type: 'copy', block: 26, from: 'fork1', to: 'fork2'})
  ...
  ops.push({type: 'copy', block: 46, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '295'})
  ops.push({type: 'append', value: '292'})
  ops.push({type: 'append', value: '291'})
  ops.push({type: 'copy', block: 46, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '288'})
  ops.push({type: 'append', value: '277'})
  ops.push({type: 'copy', block: 51, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 39, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '271'})
  ops.push({type: 'append', value: '269'})
  ops.push({type: 'copy', block: 45, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '264'})
  ops.push({type: 'copy', block: 51, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '262'})
  ops.push({type: 'copy', block: 20, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '259'})
  ops.push({type: 'copy', block: 45, from: 'fork1', to: 'fork2'})
  ops.push({type: 'copy', block: 39, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '256'})
  ops.push({type: 'append', value: '253'})
  ops.push({type: 'append', value: '252'})
  ops.push({type: 'copy', block: 56, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '249'})
  ops.push({type: 'append', value: '248'})
  ops.push({type: 'copy', block: 52, from: 'ddb', to: 'fork1'})
  ops.push({type: 'copy', block: 53, from: 'ddb', to: 'fork1'})
  ...
  ops.push({type: 'copy', block: 20, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '227'})
  ops.push({type: 'copy', block: 53, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '225'})
  ops.push({type: 'copy', block: 56, from: 'fork1', to: 'fork2'})
  ops.push({type: 'copy', block: 52, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '220'})
  ops.push({type: 'copy', block: 49, from: 'ddb', to: 'fork1'})
  ops.push({type: 'append', value: '216'})
  ops.push({type: 'copy', block: 49, from: 'fork1', to: 'fork2'})
  ...
  ops.push({type: 'copy', block: 61, from: 'fork1', to: 'fork2'})
  ops.push({type: 'copy', block: 19, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '126'})
  ops.push({type: 'copy', block: 25, from: 'fork1', to: 'fork2'})
  ops.push({type: 'append', value: '123'})
  ops.push({type: 'copy', block: 81, from: 'ddb', to: 'fork1'})
  runOps(t, ops)
})

tape('dDatabase Core Tests: chaos monkey randomized', function (t) {
  var ddb = create()
  var fork1
  var fork2
  var names = ['ddb', 'fork1', 'fork2']
  var runs = 500
  var repro = '  var ops = []\n'

  ddb.ready(function () {
    fork1 = create(ddb.key)
    fork2 = create(ddb.key)
    fork1.ready(function () {
      fork2.ready(loop)
    })
  })
  ...
  function loop () {
    ...
    if (Math.random() < 0.3) {
      ...
      return ddb.append('' + runs, loop)
    }
    if (Math.random() < 0.5) return process.nextTick(loop)

    var from = [ddb, fork1, fork2][(Math.random() * 3) | 0]
    var to = null
    if (from === fork1) to = fork2
    else if (from === fork2) to = fork1
    else to = [fork1, fork1][(Math.random() * 2) | 0]
  ...
  function name (f) {
    return names[[ddb, fork1, fork2].indexOf(f)]
  }
})
...
function runOps (t, ops) {
  ...
  function get (name) {
    if (name === 'ddb') return ddb
    if (name === 'fork1') return fork1
    return fork2
  }
