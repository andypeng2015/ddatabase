...
tape('dDatabase Core Tests: digest', function (t) {
  var index = tree()
...
tape('dDatabase Core Tests: verified by', function (t) {
  var index = tree()
...
tape('dDatabase Core Tests: proof without a digest', function (t) {
  var index = tree()
...
tape('dDatabase Core Tests: proof with a digest', function (t) {
  var index = tree()
  t.same(index.proof(0), null)
...
tape('dDatabase Core Tests: digest sanity checks', function (t) {
  var index = tree()
  index.set(0)
...
tape('dDatabase Core Tests: chaos monkey test #1', function (t) {
  var source = tree()
  var fork = tree()
  var i = 0

  source.set(0)
  copy(0, source, fork, t)
  for (i = 0; i < 20; i += 2) source.set(i)
  copy(9, source, fork, t)
  for (i = 0; i < 28; i += 2) source.set(i)
  copy(13, source, fork, t)
  for (i = 0; i < 44; i += 2) source.set(i)
  copy(20, source, fork, t)
  for (i = 0; i < 4400; i += 2) source.set(i)
  copy(2000, source, fork, t)
  for (i = 0; i < 4444; i += 2) source.set(i)
  copy(2010, source, fork, t)
  copy(2200, source, fork, t)
  t.end()
})

tape('dDatabase Core Tests: chaos monkey test #2', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
...
tape('dDatabase Core Tests: chaos monkey test #3', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
...
tape('dDatabase Core Tests: chaos monkey test #4', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
...
tape('dDatabase Core Tests: chaos monkey test #5', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
...
tape('dDatabase Core Tests: chaos monkey test #6', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
...
tape('dDatabase Core Tests: chaos monkey test #7', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
