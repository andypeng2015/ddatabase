...
function defineDdb () {
  ...
  Ddb.encodingLength = encodingLength
  Ddb.encode = encode
  Ddb.decode = decode

  function encodingLength (obj) {
    var length = 0
    if (!defined(obj.revelationKey)) throw new Error("revelationKey is required")
    var len = enc[0].encodingLength(obj.revelationKey)
    length += 1 + len
  ...
  function encode (obj, buf, offset) {
    ...
    if (!defined(obj.revelationKey)) throw new Error("revelationKey is required")
    buf[offset++] = 10
    enc[0].encode(obj.revelationKey, buf, offset)
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      ...
      switch (tag) {
        case 1:
        obj.revelationKey = enc[0].decode(buf, offset)
